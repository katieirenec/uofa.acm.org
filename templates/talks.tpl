...
<p>Inotify is a Linux kernel subsystem that provides a mechanism for monitoring
file system events. Never again will you have to poll files or directories for
changes. Justin will demonstrate the C API as well as the equivalent Python
API.</p>
...
JavaScript interface to your Python programs with ease.</p>
